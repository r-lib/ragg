...
supported by Cairo and PDF in the base installation`r if (has_xlib) ' (Xlib will do nothing and thus appear to be very fast)' else ''`. 
ragg will strive to keep up with the new features though it may lack behind a 
