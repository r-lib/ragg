...
[`agg_png()`](https://ragg.r-lib.org/dev/reference/agg_png.md),
[`agg_jpeg()`](https://ragg.r-lib.org/dev/reference/agg_jpeg.md) and
[`agg_tiff()`](https://ragg.r-lib.org/dev/reference/agg_tiff.md), all of
