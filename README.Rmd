...
[![Codecov test coverage](https://codecov.io/gh/r-lib/ragg/branch/master/graph/badge.svg)](https://codecov.io/gh/r-lib/ragg?branch=master)
[![R build status](https://github.com/r-lib/ragg/workflows/R-CMD-check/badge.svg)](https://github.com/r-lib/ragg/actions)
<!-- badges: end -->
...
`agg_tiff()`, both have arguments that closely match those of the `png()` and 
